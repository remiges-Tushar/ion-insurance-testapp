...
#
# Usage:
#   PROJECT_ID=my-project REGION=asia-southeast2 ./scripts/build-and-push.sh [tag]
#
...
build_and_push ion-service             "${ROOT}/ion-service"
build_and_push cs-mock                 "${ROOT}/cs-mock"
